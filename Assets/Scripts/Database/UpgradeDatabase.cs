...
public class UpgradeDatabase{
	...
	public UpgradeDatabase(){
		upgradeList.Add(new Upgrade(0,"Guild Building",10,5,2,"Members",500,500,0,10,"Increases member size"));
		upgradeList.Add(new Upgrade(1,"Storage",10,5,5,"Item Slots",300,300,0,5,"Increases storage size"));
